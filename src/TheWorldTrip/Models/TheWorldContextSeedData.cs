...
{
    public class TheWorldTripContextSeedData
    {
        private TheWorldTripContext _context;
        private UserManager<User> _userManager;

        public TheWorldTripContextSeedData(TheWorldTripContext context, UserManager<User> userManager)
        {
            _context = context;
        ...
        public async Task EnsureSeedData()
        {
            ...
            if (!_context.Trips.Any())
            {
                var usTrip = new Trip()
                {
                    ...
                    Name = "US Trip",
                    UserName = "Ufuk", // TODO Add UserName
                    Stops = new List<Stop>()
          {
